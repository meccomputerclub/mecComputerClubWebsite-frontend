...
export default function PastEventsPage() {
  ...
  }, [searchQuery, selectedCategory, selectedYear, events]);
  ...
  return (
    <main className="bg-[#F7FAFF] dark:bg-[#101624] min-h-screen">
      <PageHero title="Past Events" crumbs={[{ label: "Home", href: "/" }, { label: "Events" }, { label: "Past" }]} />
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mb-8 space-y-4">
          ...
          {showFilters && (
            <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
              <div>
                <label className="block text-sm font-semibold text-[#0B1437] dark:text-white mb-2">Category</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-[#0B1437] dark:text-white mb-2">Year</label>
                <div className="flex flex-wrap gap-2">
                  <button
        ...
        {filteredEvents.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-bold text-[#0B1437] dark:text-white mb-2">No past events found</h3>
